#!/bin/sh
# Pipeline Arch Linux da Etapa 11: autoprovisiona, compila, testa em Xvfb e
# prepara staging sem instalar conteúdo diretamente no host.
set -eu
...
install_missing_arch_build_deps() {
    ...
    run_logged "$PRIVILEGE_CMD" pacman -S --needed --noconfirm $_missing || die 'pacman -S falhou'
}
...
die 'payload instalável não está definido para a Etapa 11'
