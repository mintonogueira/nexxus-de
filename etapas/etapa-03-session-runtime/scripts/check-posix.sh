#!/bin/sh
# Auditoria estática dos wrappers da Etapa 03 contra bashisms proibidos.
set -eu
...
sh -n "$ROOT_DIR/manifests/etapa-03.conf"
...
printf '%s\n' 'OK: wrappers da Etapa 03 passaram na auditoria POSIX'
