#!/bin/sh
# Pipeline Arch Linux da Etapa 12: autoprovisiona, compila, testa e prepara
# staging isolado sem instalar conteúdo diretamente no host.
set -eu
...
die 'payload instalável não está definido para a Etapa 12'
