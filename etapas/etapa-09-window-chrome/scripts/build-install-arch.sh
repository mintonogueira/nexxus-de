#!/bin/sh
# Pipeline Arch Linux da Etapa 09: autoprovisiona, compila, testa em Xvfb e
...
. "$ROOT_DIR/manifests/etapa-09.conf"
...
die 'payload instalável não está definido para a Etapa 09'
